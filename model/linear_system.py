...
class LinearSystem(nn.Module):
    ...
    def __init__(self,
        ...
        self.F: nn.Parameter = nn.Parameter(F, requires_grad=False)                 # S_D x S_D
        self.B: nn.Parameter = nn.Parameter(B, requires_grad=False)                 # S_D x I_D
        self.H: nn.Parameter = nn.Parameter(H, requires_grad=False)                 # O_D x S_D
        self.sqrt_S_W: nn.Parameter = nn.Parameter(sqrt_S_W, requires_grad=False)   # S_D x S_D
        self.sqrt_S_V: nn.Parameter = nn.Parameter(sqrt_S_V, requires_grad=False)   # O_D x O_D
