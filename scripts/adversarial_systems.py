...
from kf_rnn.model.convolutional import CnnPredictorLeastSquares
from kf_rnn.model.sequential import RnnPredictorPretrainAnalytical
...
if __name__ == "__main__":
    ...
    os.makedirs(f"{OUTPUT_PATH}/{output_dir}", exist_ok=True)

    system_type = "UpperTriangularA"
    save_fname = f"{OUTPUT_PATH}/{output_dir}/{system_type}_log.pt"
