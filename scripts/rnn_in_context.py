...
if __name__ == "__main__":
    ...
    for _exp_name_baseline in (exp_name_cnn, exp_name_rnn):
        os.makedirs(f"{OUTPUT_PATH}/{output_dir}/{_exp_name_baseline}/training", exist_ok=True)
        os.makedirs(f"{OUTPUT_PATH}/{output_dir}/{_exp_name_baseline}/testing", exist_ok=True)
