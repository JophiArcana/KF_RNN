...
from kf_rnn.system.controller import NNControllerGroup
...
if __name__ == "__main__":
    ...
    from kf_rnn.model.sequential.rnn_controller import RnnController
    from kf_rnn.model.transformer.transformerxl_iccontroller import TransformerXLInContextController

    # Experiment setup
    exp_name = "ExplorationNoise_SmallState"
    ...
    args.training.sampling = Namespace(
    ...
    cache_fname = f"{OUTPUT_PATH}/{output_dir}/{exp_name}/result_cache.pt"
    ...
    batch_size, horizon = 128, 2000

    datasets_cache_fname = f"{OUTPUT_PATH}/{output_dir}/{exp_name}/datasets_cache.pt"
